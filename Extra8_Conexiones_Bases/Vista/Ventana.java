package Extra8_Conexiones_Bases.Vista;
...
public class Ventana extends JFrame {
    ...
    public Ventana(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(180, 222, 212));
        lblId = new JLabel("Id: ");
        ...
        panel2.setBackground(new Color(199, 137, 215));
        ...
        panel3.setBackground(new Color(194, 246, 195));

        //Panel 4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(245, 229, 170));
